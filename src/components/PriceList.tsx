                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {priceLayout === 'horizontal' ? (
                        <div className="flex items-center gap-2 flex-shrink-0" style={{ marginRight: '-50px' }}>
                        ...
                        <div className="flex flex-col items-end gap-1 flex-shrink-0" style={{ marginRight: '-50px' }}>
                          {product.promo_price && product.promo_price > 0 && product.promo_price < (product.your_price || product.base_price) ? (
                            <>
